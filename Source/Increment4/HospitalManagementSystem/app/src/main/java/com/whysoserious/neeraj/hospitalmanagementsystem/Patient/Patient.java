    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.b_p_report:
                ...
                break;
            case R.id.b_p_chat:
                i = getPackageManager().getLaunchIntentForPackage("com.example.hp.myapplication");
                break;
            case R.id.b_p_hospital:
                i = getPackageManager().getLaunchIntentForPackage("com.example.user.googlemapssearchnearby");
                break;
            case R.id.b_p_vchat:
                i = getPackageManager().getLaunchIntentForPackage("com.quickblox.sample.groupchatwebrtc");
                break;
            default:
